...
const PeerScannerStaticColumns = `torrents_peers."bep51",torrents_peers."bep51_available",torrents_peers."created_at",torrents_peers."id",torrents_peers."next_check",torrents_peers."port",torrents_peers."updated_at"`
