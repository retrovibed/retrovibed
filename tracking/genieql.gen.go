...
const UnknownHashScannerStaticColumns = `torrents_unknown_infohashes."created_at",torrents_unknown_infohashes."id",torrents_unknown_infohashes."infohash",torrents_unknown_infohashes."next_check",torrents_unknown_infohashes."updated_at"`
...
const UnknownHashInsertWithDefaultsStaticColumns = `DEFAULT,$1,$2,$3,DEFAULT`
...
func UnknownHashInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a UnknownHash) UnknownHashScannerStaticRow {
	const query = `INSERT INTO "torrents_unknown_infohashes" ("created_at","id","infohash","next_check","updated_at") VALUES (DEFAULT,$1,$2,$3,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "created_at","id","infohash","next_check","updated_at"`
	var (
		c0 sql.NullString // id
		c1 []byte         // infohash
		c2 sql.NullTime
	...
	c1 = a.Infohash
	c2.Valid = true
	c2.Time = a.NextCheck // next_check
	return NewUnknownHashScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2))
}
...
func UnknownHashDeleteByID(ctx context.Context, q sqlx.Queryer, id string) UnknownHashScannerStaticRow {
	const query = `DELETE FROM torrents_unknown_infohashes WHERE "id" = $1 RETURNING torrents_unknown_infohashes."created_at",torrents_unknown_infohashes."id",torrents_unknown_infohashes."infohash",torrents_unknown_infohashes."next_check",torrents_unknown_infohashes."updated_at"`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
...
const UnknownHashCooldownStaticColumns = `DEFAULT,$1,$2,$3,DEFAULT`
...
func UnknownHashCooldown(ctx context.Context, q sqlx.Queryer, a UnknownHash) UnknownHashScannerStaticRow {
	const query = `INSERT INTO "torrents_unknown_infohashes" ("created_at","id","infohash","next_check","updated_at") VALUES (DEFAULT,$1,$2,$3,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, next_check = NOW() + to_hours(24) RETURNING "created_at","id","infohash","next_check","updated_at"`
	var (
		c0 sql.NullString // id
		c1 []byte         // infohash
		c2 sql.NullTime
