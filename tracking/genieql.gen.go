...
const UnknownHashScannerStaticColumns = `torrents_unknown_infohashes."created_at",torrents_unknown_infohashes."id",torrents_unknown_infohashes."infohash",torrents_unknown_infohashes."updated_at"`
...
const UnknownHashInsertWithDefaultsStaticColumns = `DEFAULT,$1,$2,DEFAULT`
...
func UnknownHashInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a UnknownHash) UnknownHashScannerStaticRow {
	const query = `INSERT INTO "torrents_unknown_infohashes" ("created_at","id","infohash","updated_at") VALUES (DEFAULT,$1,$2,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "created_at","id","infohash","updated_at"`
	var (
		c0 sql.NullString // id
		c1 []byte
	)
	c0.Valid = true
	c0.String = a.ID
	c1 = a.Infohash // infohash
	return NewUnknownHashScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1))
}
...
func UnknownHashDeleteByID(ctx context.Context, q sqlx.Queryer, id string) UnknownHashScannerStaticRow {
	const query = `DELETE FROM torrents_unknown_infohashes WHERE "id" = $1 RETURNING torrents_unknown_infohashes."created_at",torrents_unknown_infohashes."id",torrents_unknown_infohashes."infohash",torrents_unknown_infohashes."updated_at"`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
