...
const PeerScannerStaticColumns = `torrents_peers."bep51",torrents_peers."bep51_available",torrents_peers."created_at",torrents_peers."id",torrents_peers."ip",torrents_peers."next_check",torrents_peers."peer",torrents_peers."port",torrents_peers."updated_at"`
...
const PeerInsertWithDefaultsStaticColumns = `$1,$2,DEFAULT,$3,$4,DEFAULT,$5,$6,DEFAULT`
...
func PeerInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Peer) PeerScannerStaticRow {
	const query = `INSERT INTO "torrents_peers" ("bep51","bep51_available","created_at","id","ip","next_check","peer","port","updated_at") VALUES ($1,$2,DEFAULT,$3,$4,DEFAULT,$5,$6,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, ip = EXCLUDED.ip, port = EXCLUDED.port, bep51_available = EXCLUDED.bep51_available RETURNING "bep51","bep51_available","created_at","id","ip","next_check","peer","port","updated_at"`
	var (
		c0 sql.NullBool   // bep51
		c1 sql.NullInt64  // bep51_available
		c2 sql.NullString // id
	...
	return NewPeerScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5))
}
