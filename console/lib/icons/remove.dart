...
class Remove extends StatelessWidget {
  ...
  const Remove({super.key, this.size, this.color});

  @override
  Widget build(BuildContext context) => SvgIcon(_svg, size: size, color: color);
}
