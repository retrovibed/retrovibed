...
//go:generate protoc --proto_path=.proto --go_opt=Meg.compute.authz.proto=github.com/egciorg/eg/compute --go_opt=paths=source_relative --go_out=compute eg.compute.authz.proto
