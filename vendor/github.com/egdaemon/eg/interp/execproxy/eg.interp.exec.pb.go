...
var file_eg_interp_exec_proto_rawDesc = []byte{
...
var (
	...
	file_eg_interp_exec_proto_rawDescData = file_eg_interp_exec_proto_rawDesc
)

func file_eg_interp_exec_proto_rawDescGZIP() []byte {
	file_eg_interp_exec_proto_rawDescOnce.Do(func() {
		file_eg_interp_exec_proto_rawDescData = protoimpl.X.CompressGZIP(file_eg_interp_exec_proto_rawDescData)
	})
	return file_eg_interp_exec_proto_rawDescData
}

var file_eg_interp_exec_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_eg_interp_exec_proto_goTypes = []interface{}{
...
func file_eg_interp_exec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_eg_interp_exec_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eg_interp_exec_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eg_interp_exec_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_eg_interp_exec_proto_rawDesc = nil
