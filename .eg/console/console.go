...
func GenerateProtocol(ctx context.Context, _ eg.Op) error {
	...
	return shell.Run(
		...
		runtime.New("PATH=\"${PATH}:${HOME}/.pub-cache/bin\" protoc --dart_out=grpc:console/lib -I.proto .proto/community/community.proto .proto/ftux/ftux.proto"),
		// frontend exclusive
