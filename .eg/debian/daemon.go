...
func init() {
	...
	gcfg = egdebuild.New(
		...
		egdebuild.Option.DependsBuild("golang-1.26", "dh-make", "debhelper", "pkg-config", "duckdb", "libavcodec-dev", "libavformat-dev", "libavutil-dev", "libswresample-dev", "libavfilter-dev", "libavdevice-dev", "libswscale-dev"),
