...
func GenerateProtocol(ctx context.Context, op eg.Op) error {
	...
	return shell.Run(
		...
		// library
		gruntime.New("protoc --proto_path=../.proto --go_opt=Mlibrary/library.watch.proto=github.com/retrovibed/retrovibed/shallows/library --go_opt=paths=import --go_opt=module=github.com/retrovibed/retrovibed/shallows --go_out=. library/library.watch.proto"),
		// media
		...
		gruntime.New("protoc --proto_path=../.proto --go_opt=Mmedia/media.filesystem.proto=github.com/retrovibed/retrovibed/shallows/media --go_opt=Mmedia/media.proto=github.com/retrovibed/retrovibed/shallows/media --go_opt=paths=import --go_opt=module=github.com/retrovibed/retrovibed/shallows --go_out=. media/media.filesystem.proto"),
		...
		gruntime.New("protoc --proto_path=../.proto --go_opt=Mcommunity/community.social.proto=github.com/retrovibed/retrovibed/shallows/communityapi --go_opt=Mcommunity/community.proto=github.com/retrovibed/retrovibed/shallows/communityapi --go_opt=paths=import --go_opt=module=github.com/retrovibed/retrovibed/shallows --go_out=. community/community.social.proto"),
		gruntime.New("protoc --proto_path=../.proto --go_opt=Mftux/ftux.proto=github.com/retrovibed/retrovibed/shallows/ftuxapi --go_opt=Mcommunity/community.proto=github.com/retrovibed/retrovibed/shallows/communityapi --go_opt=paths=import --go_opt=module=github.com/retrovibed/retrovibed/shallows --go_out=. ftux/ftux.proto"),
		// ddisc
