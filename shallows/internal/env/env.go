...
const (
	...
	MediaIdentificationDisabled = "RETROVIBED_MEDIA_IDENTIFICATION_DISABLED"    // disable loading the media identification neural model, falls back to a noop cleaner.
