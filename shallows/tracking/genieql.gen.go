...
const RSSScannerStaticColumns = `torrents_feed_rss."autoarchive",torrents_feed_rss."autodownload",torrents_feed_rss."created_at",torrents_feed_rss."description",torrents_feed_rss."disabled_at",torrents_feed_rss."id",torrents_feed_rss."next_check",torrents_feed_rss."updated_at",torrents_feed_rss."url"`
...
const RSSInsertWithDefaultsStaticColumns = `$1,$2,DEFAULT,$3,DEFAULT,$4,DEFAULT,DEFAULT,$5`
...
func RSSInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autoarchive","autodownload","created_at","description","disabled_at","id","next_check","updated_at","url") VALUES ($1,$2,DEFAULT,$3,DEFAULT,$4,DEFAULT,DEFAULT,$5) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, autodownload = EXCLUDED.autodownload, autoarchive = EXCLUDED.autoarchive, url = EXCLUDED.url, description = EXCLUDED.description RETURNING "autoarchive","autodownload","created_at","description","disabled_at","id","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autoarchive
		c1 sql.NullBool   // autodownload
		c2 sql.NullString // description
...
const RSSCooldownStaticColumns = `$1,$2,DEFAULT,$3,$4,$5,$6,DEFAULT,$7`
...
func RSSCooldownExplode(a *RSS) ([]interface{}, error) {
	var (
		...
		c1 sql.NullBool   // autodownload
		c2 sql.NullString // description
		c3 sql.NullTime   // disabled_at
		c4 sql.NullString // id
		c5 sql.NullTime   // next_check
		c6 sql.NullString // url
	)
...
func RSSCooldown(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autoarchive","autodownload","created_at","description","disabled_at","id","next_check","updated_at","url") VALUES ($1,$2,DEFAULT,$3,$4,$5,$6,DEFAULT,$7) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, next_check = NOW() + to_minutes({ttl}) RETURNING "autoarchive","autodownload","created_at","description","disabled_at","id","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autoarchive
		c1 sql.NullBool   // autodownload
		c2 sql.NullString // description
	...
	c6.Valid = true
	c6.String = a.URL // url
	return NewRSSScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5, c6))
}
...
func RSSCooldownByID(ctx context.Context, q sqlx.Queryer, id string, ttl int) RSSScannerStaticRow {
	const query = `UPDATE torrents_feed_rss SET updated_at = DEFAULT, next_check = NOW() + to_minutes($2) WHERE "id" = $1 RETURNING torrents_feed_rss."autoarchive",torrents_feed_rss."autodownload",torrents_feed_rss."created_at",torrents_feed_rss."description",torrents_feed_rss."disabled_at",torrents_feed_rss."id",torrents_feed_rss."next_check",torrents_feed_rss."updated_at",torrents_feed_rss."url"`
	var (
...
func RSSDeleteByID(ctx context.Context, q sqlx.Queryer, id string) RSSScannerStaticRow {
	const query = `DELETE FROM torrents_feed_rss WHERE "id" = $1 RETURNING torrents_feed_rss."autoarchive",torrents_feed_rss."autodownload",torrents_feed_rss."created_at",torrents_feed_rss."description",torrents_feed_rss."disabled_at",torrents_feed_rss."id",torrents_feed_rss."next_check",torrents_feed_rss."updated_at",torrents_feed_rss."url"`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
