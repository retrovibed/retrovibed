...
const MetadataScannerStaticColumns = `torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."tracker",torrents_metadata."updated_at"`
...
const MetadataInsertWithDefaultsStaticColumns = `$1,DEFAULT,$2,DEFAULT,DEFAULT,$3,$4,DEFAULT,DEFAULT,$5,$6,DEFAULT`
...
func MetadataInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Metadata) MetadataScannerStaticRow {
	const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,DEFAULT,DEFAULT,$3,$4,DEFAULT,DEFAULT,$5,$6,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
	var (
		c0 sql.NullInt64  // bytes
		c1 sql.NullString // description
		c2 sql.NullString // id
	...
	c4.Int32 = int32(a.Peers)
	c5.Valid = true
	c5.String = a.Tracker // tracker
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5))
}
...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullInt64, c1 sql.NullString, c2 sql.NullInt64, c3 sql.NullTime, c4 []byte, c5 sql.NullTime, c6 sql.NullTime, c7 sql.NullInt32, c8 sql.NullString, err error) {
		c0.Valid = true
	...
	case 1:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, err = transform(p[0]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8)), p[1:], true
	case 2:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, err = transform(p[1]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8)), p[2:], true
	case 3:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, err = transform(p[2]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8)), p[3:], true
	case 4:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT),($28,DEFAULT,$29,$30,$31,DEFAULT,$32,$33,$34,$35,$36,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, err = transform(p[3]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8)), p[4:], true
	case 5:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT),($28,DEFAULT,$29,$30,$31,DEFAULT,$32,$33,$34,$35,$36,DEFAULT),($37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,$43,$44,$45,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, err = transform(p[4]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8)), p[5:], true
	case 6:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT),($28,DEFAULT,$29,$30,$31,DEFAULT,$32,$33,$34,$35,$36,DEFAULT),($37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,$43,$44,$45,DEFAULT),($46,DEFAULT,$47,$48,$49,DEFAULT,$50,$51,$52,$53,$54,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, err = transform(p[5]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8)), p[6:], true
	case 7:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT),($28,DEFAULT,$29,$30,$31,DEFAULT,$32,$33,$34,$35,$36,DEFAULT),($37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,$43,$44,$45,DEFAULT),($46,DEFAULT,$47,$48,$49,DEFAULT,$50,$51,$52,$53,$54,DEFAULT),($55,DEFAULT,$56,$57,$58,DEFAULT,$59,$60,$61,$62,$63,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, err = transform(p[6]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8)), p[7:], true
	case 8:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT),($28,DEFAULT,$29,$30,$31,DEFAULT,$32,$33,$34,$35,$36,DEFAULT),($37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,$43,$44,$45,DEFAULT),($46,DEFAULT,$47,$48,$49,DEFAULT,$50,$51,$52,$53,$54,DEFAULT),($55,DEFAULT,$56,$57,$58,DEFAULT,$59,$60,$61,$62,$63,DEFAULT),($64,DEFAULT,$65,$66,$67,DEFAULT,$68,$69,$70,$71,$72,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, err = transform(p[7]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8)), p[8:], true
	case 9:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT),($28,DEFAULT,$29,$30,$31,DEFAULT,$32,$33,$34,$35,$36,DEFAULT),($37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,$43,$44,$45,DEFAULT),($46,DEFAULT,$47,$48,$49,DEFAULT,$50,$51,$52,$53,$54,DEFAULT),($55,DEFAULT,$56,$57,$58,DEFAULT,$59,$60,$61,$62,$63,DEFAULT),($64,DEFAULT,$65,$66,$67,DEFAULT,$68,$69,$70,$71,$72,DEFAULT),($73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,$79,$80,$81,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, err = transform(p[8]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8)), p[9:], true
	default:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5,$6,$7,$8,$9,DEFAULT),($10,DEFAULT,$11,$12,$13,DEFAULT,$14,$15,$16,$17,$18,DEFAULT),($19,DEFAULT,$20,$21,$22,DEFAULT,$23,$24,$25,$26,$27,DEFAULT),($28,DEFAULT,$29,$30,$31,DEFAULT,$32,$33,$34,$35,$36,DEFAULT),($37,DEFAULT,$38,$39,$40,DEFAULT,$41,$42,$43,$44,$45,DEFAULT),($46,DEFAULT,$47,$48,$49,DEFAULT,$50,$51,$52,$53,$54,DEFAULT),($55,DEFAULT,$56,$57,$58,DEFAULT,$59,$60,$61,$62,$63,DEFAULT),($64,DEFAULT,$65,$66,$67,DEFAULT,$68,$69,$70,$71,$72,DEFAULT),($73,DEFAULT,$74,$75,$76,DEFAULT,$77,$78,$79,$80,$81,DEFAULT),($82,DEFAULT,$83,$84,$85,DEFAULT,$86,$87,$88,$89,$90,DEFAULT) RETURNING "bytes","created_at","description","downloaded","hidden_at","id","infohash","initiated_at","paused_at","peers","tracker","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
		...
		if r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8, err = transform(p[9]); err != nil {
			return NewMetadataScannerStatic(nil, err), []Metadata(nil), false
		}
		return NewMetadataScannerStatic(t.q.QueryContext(t.ctx, query, r0c0, r0c1, r0c2, r0c3, r0c4, r0c5, r0c6, r0c7, r0c8, r1c0, r1c1, r1c2, r1c3, r1c4, r1c5, r1c6, r1c7, r1c8, r2c0, r2c1, r2c2, r2c3, r2c4, r2c5, r2c6, r2c7, r2c8, r3c0, r3c1, r3c2, r3c3, r3c4, r3c5, r3c6, r3c7, r3c8, r4c0, r4c1, r4c2, r4c3, r4c4, r4c5, r4c6, r4c7, r4c8, r5c0, r5c1, r5c2, r5c3, r5c4, r5c5, r5c6, r5c7, r5c8, r6c0, r6c1, r6c2, r6c3, r6c4, r6c5, r6c6, r6c7, r6c8, r7c0, r7c1, r7c2, r7c3, r7c4, r7c5, r7c6, r7c7, r7c8, r8c0, r8c1, r8c2, r8c3, r8c4, r8c5, r8c6, r8c7, r8c8, r9c0, r9c1, r9c2, r9c3, r9c4, r9c5, r9c6, r9c7, r9c8)), []Metadata(nil), false
	}
}
...
func MetadataFindByID(ctx context.Context, q sqlx.Queryer, id string) MetadataScannerStaticRow {
	const query = `SELECT torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."tracker",torrents_metadata."updated_at" FROM torrents_metadata WHERE "id" = $1`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0))
...
func MetadataProgressByID(ctx context.Context, q sqlx.Queryer, id string, peers uint16, completed uint64) MetadataScannerStaticRow {
	const query = `UPDATE torrents_metadata SET updated_at = NOW(), downloaded = $3, peers = $2 WHERE "id" = $1 RETURNING torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."hidden_at",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."paused_at",torrents_metadata."peers",torrents_metadata."tracker",torrents_metadata."updated_at"`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0, peers, completed))
}
...
func RSSCooldown(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autodownload","created_at","description","id","next_check","updated_at","url") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, next_check = NOW() + to_minutes({ttl}) RETURNING "autodownload","created_at","description","id","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autodownload
		c1 sql.NullString // description
		c2 sql.NullString // id
...
func RSSCooldownByID(ctx context.Context, q sqlx.Queryer, id string, ttl int) RSSScannerStaticRow {
	const query = `UPDATE torrents_feed_rss SET updated_at = DEFAULT, next_check = NOW() + to_minutes($2) WHERE "id" = $1 RETURNING torrents_feed_rss."autodownload",torrents_feed_rss."created_at",torrents_feed_rss."description",torrents_feed_rss."id",torrents_feed_rss."next_check",torrents_feed_rss."updated_at",torrents_feed_rss."url"`
	var (
