...
const MetadataScannerStaticColumns = `torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."updated_at"`
...
const MetadataInsertWithDefaultsStaticColumns = `$1,DEFAULT,$2,$3,$4,$5,$6,DEFAULT`
...
func MetadataInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Metadata) MetadataScannerStaticRow {
	const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,$4,$5,$6,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
	var (
		c0 sql.NullInt64  // bytes
		c1 sql.NullString // description
		c2 sql.NullInt64  // downloaded
	...
	c4 = a.Infohash
	c5.Valid = true
	c5.Time = a.InitiatedAt // initiated_at
...
func (t *metadataBatchInsertWithDefaults) advance(p ...Metadata) (MetadataScanner, []Metadata, bool) {
	transform := func(p Metadata) (c0 sql.NullInt64, c1 sql.NullString, c2 sql.NullInt64, c3 []byte, c4 sql.NullTime, err error) {
		c0.Valid = true
	...
	case 1:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 2:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 3:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 4:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT),($16,DEFAULT,$17,$18,DEFAULT,$19,$20,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 5:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT),($16,DEFAULT,$17,$18,DEFAULT,$19,$20,DEFAULT),($21,DEFAULT,$22,$23,DEFAULT,$24,$25,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 6:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT),($16,DEFAULT,$17,$18,DEFAULT,$19,$20,DEFAULT),($21,DEFAULT,$22,$23,DEFAULT,$24,$25,DEFAULT),($26,DEFAULT,$27,$28,DEFAULT,$29,$30,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 7:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT),($16,DEFAULT,$17,$18,DEFAULT,$19,$20,DEFAULT),($21,DEFAULT,$22,$23,DEFAULT,$24,$25,DEFAULT),($26,DEFAULT,$27,$28,DEFAULT,$29,$30,DEFAULT),($31,DEFAULT,$32,$33,DEFAULT,$34,$35,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 8:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT),($16,DEFAULT,$17,$18,DEFAULT,$19,$20,DEFAULT),($21,DEFAULT,$22,$23,DEFAULT,$24,$25,DEFAULT),($26,DEFAULT,$27,$28,DEFAULT,$29,$30,DEFAULT),($31,DEFAULT,$32,$33,DEFAULT,$34,$35,DEFAULT),($36,DEFAULT,$37,$38,DEFAULT,$39,$40,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	case 9:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT),($16,DEFAULT,$17,$18,DEFAULT,$19,$20,DEFAULT),($21,DEFAULT,$22,$23,DEFAULT,$24,$25,DEFAULT),($26,DEFAULT,$27,$28,DEFAULT,$29,$30,DEFAULT),($31,DEFAULT,$32,$33,DEFAULT,$34,$35,DEFAULT),($36,DEFAULT,$37,$38,DEFAULT,$39,$40,DEFAULT),($41,DEFAULT,$42,$43,DEFAULT,$44,$45,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
	...
	default:
		const query = `INSERT INTO "torrents_metadata" ("bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at") VALUES ($1,DEFAULT,$2,$3,DEFAULT,$4,$5,DEFAULT),($6,DEFAULT,$7,$8,DEFAULT,$9,$10,DEFAULT),($11,DEFAULT,$12,$13,DEFAULT,$14,$15,DEFAULT),($16,DEFAULT,$17,$18,DEFAULT,$19,$20,DEFAULT),($21,DEFAULT,$22,$23,DEFAULT,$24,$25,DEFAULT),($26,DEFAULT,$27,$28,DEFAULT,$29,$30,DEFAULT),($31,DEFAULT,$32,$33,DEFAULT,$34,$35,DEFAULT),($36,DEFAULT,$37,$38,DEFAULT,$39,$40,DEFAULT),($41,DEFAULT,$42,$43,DEFAULT,$44,$45,DEFAULT),($46,DEFAULT,$47,$48,DEFAULT,$49,$50,DEFAULT) RETURNING "bytes","created_at","description","downloaded","id","infohash","initiated_at","updated_at"`
		var (
			r0c0 sql.NullInt64
			r0c1 sql.NullString
			r0c2 sql.NullInt64
...
func MetadataDeleteByID(ctx context.Context, q sqlx.Queryer, id string) MetadataScannerStaticRow {
	const query = `DELETE FROM torrents_metadata WHERE "id" = $1 RETURNING torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."updated_at"`
...
func MetadataFindByID(ctx context.Context, q sqlx.Queryer, id string) MetadataScannerStaticRow {
	const query = `SELECT torrents_metadata."bytes",torrents_metadata."created_at",torrents_metadata."description",torrents_metadata."downloaded",torrents_metadata."id",torrents_metadata."infohash",torrents_metadata."initiated_at",torrents_metadata."updated_at" FROM torrents_metadata WHERE "id" = $1`
	var c0 sql.NullString // id
	c0.Valid = true
	c0.String = id
	return NewMetadataScannerStaticRow(q.QueryRowContext(ctx, query, c0))
...
const RSSInsertWithDefaultsStaticColumns = `$1,DEFAULT,$2,$3,$4,DEFAULT,$5`
...
func RSSInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a RSS) RSSScannerStaticRow {
	const query = `INSERT INTO "torrents_feed_rss" ("autodownload","created_at","description","id","next_check","updated_at","url") VALUES ($1,DEFAULT,$2,$3,$4,DEFAULT,$5) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "autodownload","created_at","description","id","next_check","updated_at","url"`
	var (
		c0 sql.NullBool   // autodownload
		c1 sql.NullString // description
		c2 sql.NullString // id
