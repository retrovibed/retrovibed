...
//go:generate gomodifytags -w -all -quiet -skip-unexported -add-tags json -file genieql.cache.gen.go
...
//go:generate gomodifytags -w -quiet -struct Known -field Md5Lower -add-options json=string -file genieql.cache.gen.go
