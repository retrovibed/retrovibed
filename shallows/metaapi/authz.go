...
func AuthzPermLibraryModify(ctx context.Context, cause error) (_ context.Context, token *Token, err error) {
	if cause != nil {
		return ctx, nil, errorsx.Authorization(fmt.Errorf("not authorized"))
	}
