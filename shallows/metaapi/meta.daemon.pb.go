...
type Daemon struct {
	...
	Default       bool                   `protobuf:"varint,100,opt,name=default,proto3" json:"default,omitempty"`
	Downloads     bool                   `protobuf:"varint,101,opt,name=downloads,proto3" json:"downloads,omitempty"`
...
func (x *Daemon) GetDownloads() bool {
	if x != nil {
		return x.Downloads
	}
	return false
...
const file_meta_meta_daemon_proto_rawDesc = "" +
	...
	"\adefault\x18d \x01(\bR\adefault\x12\x1c\n" +
	"\tdownloads\x18e \x01(\bR\tdownloads\"Y\n" +
