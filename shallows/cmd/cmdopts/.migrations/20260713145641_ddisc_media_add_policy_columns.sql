...
INSERT INTO ddisc_media (
  id, infohash, created_at, updated_at, next_check_at, attempts, hidden_at, tombstoned_at, released_at,
  title, "collation", description, mimetype, bytes, video_resolution, video_runtime, audio_bitrate,
...
-- +goose Down
-- +goose StatementBegin
ALTER TABLE ddisc_media DROP COLUMN health;
ALTER TABLE ddisc_media DROP COLUMN policy_rank;
ALTER TABLE ddisc_media DROP COLUMN policy_rejection;
-- +goose StatementEnd
