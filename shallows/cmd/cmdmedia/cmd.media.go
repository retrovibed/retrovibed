...
type Known struct {
	...
	Tarchive    tarchiveimport `cmd:"" help:"import known media from a directory of tar.gz archives and writes to stdout in known media jsonl format for importing"`
	Duckdb      duckdbimport   `cmd:"" help:"import known media from a duckdb database and writes to stdout in known media jsonl format for importing"`
