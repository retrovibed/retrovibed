...
func AuthzUpsertWithDefaults(
	...
	gql.Into("authz_meta").
		...
		Conflict("ON CONFLICT (profile_id) DO UPDATE SET usermanagement = EXCLUDED.usermanagement, remote_control = EXCLUDED.remote_control, billing_read = EXCLUDED.billing_read, billing_modify = EXCLUDED.billing_modify, community_modify = EXCLUDED.community_modify, library_read = EXCLUDED.library_read, library_modify = EXCLUDED.library_modify, local_only = EXCLUDED.local_only, updated_at = DEFAULT")
}
