...
type Profile struct {
	...
	DisabledManuallyAt        time.Time
	DisabledPendingApprovalAt time.Time
	ID                        string
...
const ProfileInsertWithDefaultsStaticColumns = `DEFAULT,$1,$2,$3,$4,$5,$6,DEFAULT`
...
func ProfileInsertWithDefaultsExplode(a *Profile) ([]interface{}, error) {
	var (
		...
		c1 sql.NullTime   // disabled_at
		c2 sql.NullTime   // disabled_manually_at
		c3 sql.NullTime   // disabled_pending_approval_at
		c4 sql.NullString // id
		c5 sql.NullString // session_watermark
	)
	...
	c1.Valid = true
	c1.Time = a.DisabledAt

	c2.Valid = true
	c2.Time = a.DisabledManuallyAt

	c3.Valid = true
	c3.Time = a.DisabledPendingApprovalAt

	c4.Valid = true
	c4.String = a.ID

	c5.Valid = true
	c5.String = a.SessionWatermark
...
func ProfileInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Profile) ProfileScannerStaticRow {
	const query = `INSERT INTO "meta_profiles" ("created_at","description","disabled_at","disabled_manually_at","disabled_pending_approval_at","id","session_watermark","updated_at") VALUES (DEFAULT,$1,$2,$3,$4,$5,$6,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT RETURNING "created_at","description","disabled_at","disabled_manually_at","disabled_pending_approval_at","id","session_watermark","updated_at"`
	var (
		c0 sql.NullString // description
		c1 sql.NullTime   // disabled_at
		c2 sql.NullTime   // disabled_manually_at
	...
	c4.String = a.ID
	c5.Valid = true
	c5.String = a.SessionWatermark // session_watermark
	return NewProfileScannerStaticRow(q.QueryRowContext(ctx, query, c0, c1, c2, c3, c4, c5))
}
