...
func IdentityFindByCreatedAt(ctx context.Context, q sqlx.Queryer, c ducktype.NullTime) IdentityScannerStaticRow {
...
func IdentityFindByDisabledAt(ctx context.Context, q sqlx.Queryer, c ducktype.NullTime) IdentityScannerStaticRow {
...
func IdentityFindByUpdatedAt(ctx context.Context, q sqlx.Queryer, c ducktype.NullTime) IdentityScannerStaticRow {
...
func IdentityInsertWithDefaults(ctx context.Context, q sqlx.Queryer, a Identity) IdentityScannerStaticRow {
	const query = `INSERT INTO "meta_sso_identity_ssh" ("created_at","disabled_at","id","profile_id","public_key","updated_at") VALUES (DEFAULT,$1,$2,$3,$4,DEFAULT) ON CONFLICT (id) DO UPDATE SET updated_at = DEFAULT, profile_id = EXCLUDED.profile_id RETURNING "created_at","disabled_at","id","profile_id","public_key","updated_at"`
	var (
		c0 ducktype.NullTime // disabled_at
		c1 sql.NullString    // id
		c2 sql.NullString    // profile_id
...
// IdentityInsertZeroWithDefaultsStaticColumns generated by genieql
const IdentityInsertZeroWithDefaultsStaticColumns = `DEFAULT,$1,$2,$3,$4,DEFAULT`

// IdentityInsertZeroWithDefaultsExplode generated by genieql
func IdentityInsertZeroWithDefaultsExplode(a *Identity) ([]interface{}, error) {
	var (
		c0 ducktype.NullTime // disabled_at
		c1 sql.NullString    // id
		c2 sql.NullString    // profile_id
...
// IdentityInsertZeroWithDefaults generated by genieql
// used to insert an identity for the oauth2 endpoint
func IdentityInsertZeroWithDefaults(ctx context.Context, q sqlx.Queryer, a Identity) IdentityScannerStaticRow {
