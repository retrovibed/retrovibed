...
// DiscoveryCreate creates a discovery entry on the given library endpoint.
func DiscoveryCreate(ctx context.Context, c *http.Client, endpoint string, req *DiscoveryCreateRequest) (resp *DiscoveryCreateResponse, err error) {
	...
	resp = new(DiscoveryCreateResponse)
