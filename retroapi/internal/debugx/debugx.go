...
import (
	...
	"github.com/retrovibed/retroapi/internal/contextx"
	"github.com/retrovibed/retroapi/internal/errorsx"
	"github.com/retrovibed/retroapi/internal/iox"
...
func run(ctx context.Context, dir string, strategy func(*profile.Profile)) (err error) {
	...
	defer func() {
		errorsx.Log(errorsx.Wrap(os.RemoveAll(tmpdir), "failed to remove profile tmp directory"))
	}()
